class PlayerCharector:
    ...
    Skill_List = [["검의 신판","강력한 의지","근력강화","분노의 일격"],["벌목","고기뜯어먹기","광기","내려찍기"]] #캐릭터 스킬 리스트 이중 리스트
    Skill_basic_damage = [[0,0,0,150],[150,0,0,250]] #스킬 공격력 데미지 리스트 이중 리스트
    Skill_basic_magic_damage = [[100,0,0,0],[0,0,0,0]] #스킬 주문력 데미지 리스트 이중 리스트
    Skill_damage_per = [[0.2,0,0,0],[0.5,0,0,0.8]] #스킬 공격력 데미지 리스트 퍼센트 이중 리스트
    Skill_magic_damage_per = [[0,0,0,0.5],[0,0,0,0]] #스킬 주문력 데미지 리스트 퍼센트 이중 리스트
    stats_list = [[10,0,100,100,1000],[30,0,30,30,500]] #캐릭터 스텟 리스트 이중 변수
