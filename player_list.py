class PlayerCharector:
    ...
    Charector_List = ["아서","미스터 톰","블랜","섀도어"] #캐릭터 리스트
    Skill_List = [["검의 신판","강력한 의지","근력강화","분노의 일격"],["난사","구르기","집중","헤드 샷"],["피의사슬","신체혈화","블러드스피어","흡혈"],["은신","목긋기","독살","협박"]] #캐릭터 스킬 리스트 이중 리스트
    Skill_basic_damage = [[0,0,0,150],[100,0,0,300],[0,0,0,0],[0,0,0,0]] #스킬 공격력 데미지 리스트 이중 리스트
    Skill_basic_magic_damage = [[100,0,0,0],[0,0,0,0],[50,0,200,100],[200,0,250,0]] #스킬 주문력 데미지 리스트 이중 리스트
    Skill_damage_per = [[0.2,0,0,0],[0.3,0,0,0.5],[0,0,0,0],[0.5,0,0,0]] #스킬 공격력 데미지 리스트 퍼센트 이중 리스트
    Skill_magic_damage_per = [[0,0,0,0.5],[0,0,0,0],[0.2,0,0.8,0],[0,0,0,0.9]] #스킬 주문력 데미지 리스트 퍼센트 이중 리스트
    stats_list = [[15,20,60,60,1000],[30,10,5,5,500],[10,50,30,30,500],[50,50,0,0,300]] #캐릭터 스텟 리스트 이중 변수
